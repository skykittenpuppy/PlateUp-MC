...
summon item_display ~ ~0.53125 ~ {transformation:[0.8750f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,-0.8750f,0.0000f,0.0000f,0.8750f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
