...
execute as @e[limit=1, sort=nearest, type=interaction] unless score @s doprog matches 0 if items block ~ ~-1.5 ~ container.0 emerald[minecraft:custom_model_data=3] run function plateup:recipes/counter/raw_steak
