...
summon item_display ~ ~ ~ {Tags:[block], transformation:[1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.5000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f], item:{id:"plateup:counter"}}
...
scoreboard players set @n[tag=interaction] progress 0
scoreboard players set @n[tag=interaction] doprog 0